import { deleteModal } from "./detete_modal.js";
    ...
    () => {
        ...
        function init() {
            ...
            addFolderButton.addEventListener("click", () => {
                ...
                const footer = document.createElement("footer"); // I should probably componentize the footer like I did
                const footerGoBack = document.createElement("button"); // with the modal, but I'll do it later
                ...
                footerAdd.addEventListener("click", () => {
                    ...
                    deleteTodo.addEventListener("click", () => {
                        deleteModal.delete_element(todoNameH2.innerText, todo, todoContainer, todos);
                    });
                ...
                deleteFolder.addEventListener("click", () => {
                    deleteModal.delete_element(folderName.innerText, folderContainer, todoContainer, folders);
                })
